...
4.  [**Authentication & Permissions**](./authentication_permissions.md): How users are authenticated against LDAP, how access to every API endpoint is declared and enforced (access rules, startup check, tests). **Read this before adding or changing an endpoint.**
