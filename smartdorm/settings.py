...
MIDDLEWARE = [
    ...
    'smartdorm.middleware.SubtenantApiGuardMiddleware',  # must run after authentication
...
REST_FRAMEWORK = {
    ...
    # German "du" texts for DRF's own 403/404/login/CSRF messages
    'EXCEPTION_HANDLER': 'smartdorm.exceptions.exception_handler',
}
