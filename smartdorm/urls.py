...
tenant_urlpatterns = [
    ...
    path('onboarding/complete/', tenant_views.complete_tutorial_view, name='onboarding-complete'),
    path('onboarding/reset/', tenant_views.reset_tutorial_view, name='onboarding-reset'),
